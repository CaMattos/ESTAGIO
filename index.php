  ...
  <body>
    ...
    <div class="container">
      ...
      <h1>Negociação de Mercadorias</h1>
        <p class="lead">Bem vindo, para acessar a plataforma de gerenciamento clique no botão abaixo.</p>
        <p><a class="btn btn-lg btn-success" href="cadastro.php" role="button">Cadastrar Mercadorias</a></p>
