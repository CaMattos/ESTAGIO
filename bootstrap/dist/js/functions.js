$(function () {
  ...
  function Create() {
    ...
    var person = JSON.stringify({
      ...
      Tipo: $("#txtTipo").val(),
      Nome: $("#txtNome").val(),
      Quantidade: $("#txtQnt").val(),
      Preco: $("#txtPreco").val(),
      Negociação:$("#txtNeg").val()
    }); 
...
//função controle de mercadorias
...
$(function () {
  ...
  function List() {
    ...
    for (var i in tblPersons) {
        ...
        $("#tblList tbody").append("<tr>" +                    
                ...
                "<td>" + per.Preco + "</td>" + 
                "<th>" + per.Negociação +"</th>" +                   
                "<td><img src='_img/edit.png' alt='Edit" + i + "' class='btnEdit'/>&nbsp &nbsp<img src='_img/delete.png' alt='Delete" + i + "' class='btnDelete'/></td>" +
                "</tr>"
                );
  ...
  $(".btnEdit").bind("click", function () {
    ...
    $("#txtID").val(per.ID);
    $("#txtTipo").val(per.Tipo);
    $("#txtNome").val(per.Nome);
    $("#txtQnt").val(per.Quantidade);
    $("#txtPreco").val(per.Preco);
    $("#txtNeg").val(per.Negociação);
